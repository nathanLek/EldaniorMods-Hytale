...
/**
 * /es psetprice <prix> — Definir le prix de vente d'une parcelle
 */
public class ParcelSetPriceCommand extends AbstractAsyncCommand {

    private final RequiredArg<String> priceArg;

    public ParcelSetPriceCommand() {
        super("psetprice", "Definir le prix de vente d'une parcelle");
