...
/**
 * /es pinvite <joueur> — Inviter un joueur dans la parcelle
 */
public class ParcelInviteCommand extends AbstractAsyncCommand {

    private final RequiredArg<String> playerArg;

    public ParcelInviteCommand() {
        super("pinvite", "Inviter un joueur dans la parcelle");
