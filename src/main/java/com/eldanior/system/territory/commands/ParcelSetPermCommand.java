...
/**
 * /es psetperm <role:permission> <true|false> — Changer les permissions d'une parcelle
 */
public class ParcelSetPermCommand extends AbstractAsyncCommand {

    private final RequiredArg<String> rolePermArg;
    private final RequiredArg<String> valueArg;

    public ParcelSetPermCommand() {
        super("psetperm", "Changer les permissions d'une parcelle");
        this.rolePermArg = this.withRequiredArg("role:permission", "ROLE:PERMISSION", ArgTypes.STRING);
        this.valueArg = this.withRequiredArg("valeur", "true|false", ArgTypes.STRING);
    }
    ...
    public CompletableFuture<Void> executeAsync(@Nonnull CommandContext ctx) {
        ...
        String capturedRolePerm = this.rolePermArg.get(ctx);
        String capturedValue = this.valueArg.get(ctx);
        ...
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                try {
                    ...
                    boolean allowed = Boolean.parseBoolean(capturedValue);
