package com.eldanior.system.skills.skills.passives.Legendaire.Resistance;
...
public class CelestialImmortality implements IPassiveCombatSkill {
    @Override
    public boolean onDefend(Damage damage, PlayerLevelData victimData, Store<EntityStore> store, Ref<EntityStore> attackerRef, Ref<EntityStore> victimRef) {
        ...
        if (healthStat != null && healthStat.get() < (healthStat.getMax() * 0.55f)) {
