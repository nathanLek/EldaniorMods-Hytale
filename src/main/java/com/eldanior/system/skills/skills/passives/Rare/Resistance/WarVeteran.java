package com.eldanior.system.skills.skills.passives.Rare.Resistance;
...
public class WarVeteran implements IPassiveCombatSkill {
    private static final float FLAT_REDUCTION = 6.0f;
    @Override
