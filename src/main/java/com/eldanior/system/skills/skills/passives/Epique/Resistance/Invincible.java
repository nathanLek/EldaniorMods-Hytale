package com.eldanior.system.skills.skills.passives.Epique.Resistance;
...
public class Invincible implements IPassiveCombatSkill {
    @Override
    public boolean onDefend(Damage damage, PlayerLevelData victimData, Store<EntityStore> store, Ref<EntityStore> attackerRef, Ref<EntityStore> victimRef) {
        ...
        if (healthStat != null && healthStat.get() < (healthStat.getMax() * 0.45f)) {
