...
public class FuryStrike implements IPassiveCombatSkill {

    private static final HytaleLogger LOGGER = HytaleLogger.forEnclosingClass();
    private static final float CHANCE = 0.12f; // 12% de chance
    ...
    public void onAttack (Damage damage, PlayerLevelData
        ...
        if (Math.random() < CHANCE) {
            ...
            LOGGER.atInfo().log("[Skill] PREDATORY_STRIKE déclenché ! " + currentDamage + " -> " + newDamage);
            ...
            if (attackerRef != null) {
                ...
                if (playerRef != null) {
                    NotificationHelper.sendNotification(playerRef, "<color:white>Frappe de Fureur : +25% dégâts</color>", NotificationStyle.Success);
                }
