package com.eldanior.system.skills.skills.passives.Uncommon.Maitrise;
...
public class SpearMastery implements IPassiveCombatSkill {
    ...
    public boolean onAttack(Damage damage, PlayerLevelData attackerData, Store<EntityStore> store, Ref<EntityStore> attackerRef, Ref<EntityStore> victimRef) {
        ...
        if (!mainHandItem.getItemId().toLowerCase().contains("spear")) return false;

        // +10% dégâts avec une lance
