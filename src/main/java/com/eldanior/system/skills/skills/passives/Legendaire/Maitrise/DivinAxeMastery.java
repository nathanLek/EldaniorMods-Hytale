package com.eldanior.system.skills.skills.passives.Legendaire.Maitrise;
...
public class DivinAxeMastery implements IPassiveCombatSkill {
    @Override
    public boolean onAttack(Damage damage, PlayerLevelData attackerData, Store<EntityStore> store, Ref<EntityStore> attackerRef, Ref<EntityStore> victimRef) {
        ...
        if (mainHandItem == null || !mainHandItem.getItemId().toLowerCase().contains("axe")) return false;
