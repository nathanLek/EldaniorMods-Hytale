...
public enum MobXP {
    ...
    //REX_CAVE("rex cave", 1450, 600, 999),
    ...
    //OUTLANDER_HUNTER("outlander hunter", 40, 120, 370),
    ...
    // === GOBLINS ===
    //GOBLIN_OGRE("goblin ogre", 100, 200, 500),
    ...
    GOBLIN_DUKE("goblin duke", 1500, 100, 150),
    GOBLIN_SCAVENGER_BATTLEAXE("goblin scavenger battleaxe", 40, 25, 75),
    GOBLIN_SCAVENGER_SWORD("goblin scavenger sword", 40, 25, 75),
